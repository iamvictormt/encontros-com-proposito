              ...
              <div className="grid grid-cols-2 gap-8 items-end sm:pb-12">
                ...
                <div className="flex flex-col justify-start items-start gap-4 text-white/80 drop-shadow-sm">
                  <div className="flex flex-col">
                    <span className="text-[10px] sm:text-sm font-bold uppercase tracking-wider opacity-70">Código de segurança</span>
                    <span className="font-mono text-[10px] sm:text-sm font-bold text-white">{cvv}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-[10px] sm:text-sm font-bold uppercase tracking-wider opacity-70">Data nascimento</span>
                    <span className="font-mono text-[10px] sm:text-sm font-bold text-white">{birthDate || "--/--/----"}</span>
                  </div>
                </div>
              </div>
            </div>
