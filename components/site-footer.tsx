...
export function SiteFooter() {
  ...
  return (
    <footer className="glass px-4 py-16 lg:px-20 mt-20 text-brand-black relative overflow-hidden border-t border-white/20">
      ...
      <div className="mx-auto max-w-7xl mt-16 pt-8 border-t border-brand-black/5 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-6 text-xs text-gray-400 font-bold">
          <a href="#" className="hover:text-brand-black transition-colors uppercase tracking-widest">Privacidade</a>
          <a href="#" className="hover:text-brand-black transition-colors uppercase tracking-widest">Termos</a>
        </div>
      </div>
    </footer>
  );
