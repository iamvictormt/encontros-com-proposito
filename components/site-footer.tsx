        ...
        <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10 text-center md:text-left">
          <div className="space-y-6 flex flex-col items-center md:items-start">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs font-medium">
              Conectando pessoas com propósito através de experiências exclusivas e produtos
              autorais.
            </p>
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 flex items-center justify-center rounded-full bg-brand-black/5 hover:bg-brand-red/10 transition-colors text-brand-black"
              >
                <Instagram className="h-5 w-5" />
              </a>
              <a
                href="#"
                className="w-10 h-10 flex items-center justify-center rounded-full bg-brand-black/5 hover:bg-brand-green/10 transition-colors text-brand-black"
              >
