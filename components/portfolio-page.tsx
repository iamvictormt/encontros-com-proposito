      ...
      <main className="flex-1 px-4 sm:px-8 py-10 sm:py-16 lg:px-20">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-center mb-16 sm:mb-24">
            <div className="space-y-6 sm:space-y-10 relative text-center lg:text-left">
              ...
              <p className="text-gray-500 font-medium text-base sm:text-lg md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0">
          ...
          {/* Stats Bar */}
          <div className="glass rounded-[2.5rem] sm:rounded-[3rem] p-8 sm:p-12 border-white/40 shadow-2xl mb-20 sm:mb-32 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-brand-green/5 blur-3xl -mr-32 -mt-32 rounded-full" />
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
              <div className="text-center space-y-2">
                <div className="text-4xl sm:text-6xl font-black text-brand-black tracking-tighter">10+</div>
                <div className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Anos de Experiência</div>
              </div>
              <div className="text-center space-y-2 border-y md:border-y-0 md:border-x border-brand-green/10 py-6 sm:py-8 md:py-0">
                <div className="text-4xl sm:text-6xl font-black text-brand-black tracking-tighter">300+</div>
                <div className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Casos Transformados</div>
              </div>
              <div className="text-center space-y-2">
                <div className="text-4xl sm:text-6xl font-black text-brand-black tracking-tighter">99%</div>
          ...
          <div id="about" className="grid lg:grid-cols-12 gap-8 sm:gap-16 mb-20 sm:mb-32 items-start scroll-mt-32">
            <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-24 text-center lg:text-left">
              ...
              <p className="text-gray-500 font-medium leading-relaxed italic text-pretty">
            ...
            <div className="lg:col-span-8 space-y-8">
              <div className="premium-card bg-white p-8 sm:p-12 rounded-[2rem] sm:rounded-[2.5rem] shadow-xl space-y-6">
          ...
          <div className="mb-20 sm:mb-32">
            <div className="text-center mb-10 sm:mb-16 space-y-4">
              <h2 className="text-3xl sm:text-4xl font-black text-brand-black uppercase tracking-tighter">Áreas de <span className="text-brand-red">Atuação</span></h2>
          ...
          <div className="space-y-10 sm:space-y-12">
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-3 text-center sm:text-left">
              <div className="h-1 w-12 bg-brand-orange rounded-full" />
              <h2 className="text-2xl sm:text-3xl font-black text-brand-black uppercase tracking-tighter">Vozes da Comunidade</h2>
            </div>
